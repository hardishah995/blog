...
return [
	...
	"Students" => [
	"already_exists" => "That Student info already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this Student info. Please try again.",
	"delete_error" => "There was a problem deleting this Student info. Please try again.",
	"not_found" => "That Student info does not exist.",
	"update_error" => "There was a problem updating this student info. Please try again.",
	],
	"students" => [
